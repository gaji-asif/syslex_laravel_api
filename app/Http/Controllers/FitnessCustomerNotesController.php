...
class FitnessCustomerNotesController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $roles = MtbRole::all();
        $teams = UsersNote::where('user_id', $developer_id)->get();
    ...
    public function show($id)
    {
        ...
        return view('customers.show', compact('details', 'common_array'));
    }
