              ...
              <tbody id="tablecontents">
                ...
                <tr class="row1" data-id="{{ $issuetype->id }}" id="{{$issuetype->id}}">
                  ...
                  <td data-value="{{ $issuetype->id }}" style="display: flex;">
                    ...
                    <a href="#"  data-toggle="modal" data-target="#issuetypeeditmodal" class="mr-2 issueeditmodal" value="{{ $issuetype->id }}" data-issuetype="{{$issuetype->issue_type}}" data-issuecolor="{{$issuetype->color}}" data-projectid='{{$id}}'><i class="far fa-edit d-block"></i></a>
