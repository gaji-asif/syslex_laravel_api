                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title align-items-center"> 
                            <h5>Customers List ({{count($allCustomers)}})</h5>
                            <a href="{{route('customer.create')}}" class="btn btn-primary mb-3">Create New</a>
                        </div>
                    </div>
                                       ...
                                       <!--          <td>{{ date('d-m-Y', strtotime($value->ends_on))}}</td> -->
                                                ...
                                                <td>
                                                  <!--  <span class="badge badge-pill bg-success">Edit</span> 
                                                   ...
                                                   <a href="{{route('customer.show', $value->id )}}" class="btn btn-primary">View Detail</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            @endif
