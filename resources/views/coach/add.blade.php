      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="block-heading d-flex align-items-center title-pages">
             @if(isset($editData))
             <h5 class="text-truncate">Edit Coach</h5>
              @else
               <h5 class="text-truncate">Add Coach</h5>
              @endif
        ...
        <div class="col-md-12">
          <div class="form-block mb-4">
            <!-- <form enctype="multipart/form-data" action="#" method="post"> -->
              @if(isset($editData))
              {{ Form::open(['class' => '', 'files' => true, 'url' => 'coach/'.$editData->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
              @else
              {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'coach',
                ...
                <div class="form-group col-md-12">
                  <div class="block col-md-12">
                    ...
                    <div class="new-image" id="image-preview">
                      <label for="image-upload" id="image-label">Choose File</label>
                      <input type="file" name="upload_document" id="image-upload" required="" />
                    </div>
                     @endif
